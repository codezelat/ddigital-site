...
export default function AboutSection() {
  return (
    <div id="about" className="flex flex-col lg:flex-row pt-16 lg:pt-0 m-0 sm:m-5">
      <div className=" lg:w-3/5 bg-[#222222] text-white rounded-xl lg:m-5 px-6 md:px-10 shadow-2xl">
        <h2 className="text-3xl lg:text-4xl font-semibold text-center mt-12">
          Who We Are
        </h2>
        <p className="text-lg lg:text-xl text-center mt-2">
          &ldquo;Digitally Designed, Diversely Developed, Dedicated to
          Excellence!&rdquo;
        </p>
        <div id="about-video-player" className="d-none"></div>
        <p className="text-md lg:text-lg font-md text-left lg:text-justify mt-4 mb-12">
      ...
      <div className="lg:w-2/5 mt-10 lg:mt-5 bg-black text-white items-center justify-center rounded-xl lg:m-5 p-5 shadow-2xl">
        <LiteYouTubeEmbed
          id="A90XpRc5ke0"
